...
import { RARITIES, ARMORS, MATERIALS, isSellable, sellValueOf } from "@/lib/atlasLoot";
...
export default function ShopSellTab({ player, onSellWeapon, onSellArmor, onSellAccessory, onSellMaterial }) {
  ...
  const empty = wInv.length === 0 && aInv.length === 0 && accInv.length === 0 && mats.length === 0;
